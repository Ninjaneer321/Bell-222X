...
# engines/rotor =====================================================
var state = props.globals.getNode("sim/model/bell222x/state");
var engine = props.globals.getNode("sim/model/bell222x/engine");
...
var turbine = props.globals.getNode("sim/model/bell222x/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/bell222x/torque-pct", 1);
...
var rotor_step = props.globals.getNode("sim/model/bell222x/rotor-step-deg");
